...
# ============================================
# PARSER MIT UNTERSCHEIDUNG: NEUE ZEILE / FORTSETZUNG
# ============================================
...
class VokabelPDFParser:
    ...
    def fuelle_bedeutungen(self, zeilen: List[TabellenZeile]) -> List[TabellenZeile]:
        """
        Für Zeilen mit Nummer (neue Vokabel): Suchwort = erstes griechisches Wort aus linker Spalte.
        Für Zeilen ohne Nummer: Suchwort = erstes griechisches Wort aus mittlerer Spalte.
        """
        for zeile in zeilen:
            suchtext = zeile.linke_spalte if zeile.ist_neue_vokabel else zeile.mittlere_spalte
            ...
            if gefunden:
                ...
                zeile.rechte_spalte = "?"   # Keine Emojis
        return zeilen

# ============================================
# PDF-GENERATOR (BEHÄLT ORIGINAL-STRUKTUR)
# ============================================
...
class PDFGenerator:
    ...
    def erstelle_pdf(zeilen: List[TabellenZeile]) -> BytesIO:
        ...
        try:
            ...
            schrift = 'Helvetica'  # Fallback (zeigt ggf. Quadrate)
        ...
        data = [
            [Paragraph('Linke Spalte', kopf_stil),
             Paragraph('Griechisch', kopf_stil),
        ...
        table = Table(data, colWidths=[4*cm, 6*cm, 5.5*cm])
