...
# ============================================
# PDF-PARSER (mit KORRIGIERTEM Regex)
# ============================================
...
class VokabelPDFParser:
    ...
    def _parse_text(self, text: str) -> List[VokabelEintrag]:
        """Extrahiert Vokabeleinträge aus Text – mit korrigiertem Unicode-Regex"""
        eintraege = []
        lines = text.split('\n')
        
        current_pos = 1
        
        # ✅ KORRIGIERTER REGEX – funktioniert mit allen griechischen Unicode-Blöcken
...
def main():
    ...
    if uploaded_file is not None:
        ...
        if eintraege:
            ...
            preview_data = []
            for e in korrigierte_eintraege[:10]:
                preview_data.append({
                    'Nr.': e.position,
                    'Griechisch': e.griechisch,
