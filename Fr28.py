...
class TabellenZeile:
    ...
    position: int          # Zeilennummer im Original
...
# ============================================
# PDF-PARSER – ERHÄLT ORIGINALSTRUKTUR
# ============================================
...
class VokabelPDFParser:
                ...
                if text:
                    for line in text.split('\n'):
                        ...
                        if len(parts) >= 3:
                            ...
                            # Nur eine Spalte – versuchen zu erkennen, ob es links oder mitte ist
    ...
    def fuelle_bedeutungen(self, zeilen: List[TabellenZeile]) -> List[TabellenZeile]:
        """
        Füllt leere rechte Spalten mit Bedeutungen:
        ...
        """
        for zeile in zeilen:
            # Wenn bereits eine Bedeutung vorhanden, überspringen
...
def main():
    ...
    st.markdown("Lade eine Vokabelliste im PDF-Format hoch. Die App ergänzt die deutschen Bedeutungen in der rechten Spalte – vorhandene Einträge bleiben erhalten.")
    ...
    if uploaded_file:
        ...
        if zeilen:
            ...
            ergaenzt = sum(1 for z in zeilen if z.rechte_spalte and not z.rechte_spalte.strip() and z.ist_neue_vokabel)
