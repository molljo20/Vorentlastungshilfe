...
class OmegaWortschatz:
    ...
    def _build_dictionary(self):
        ...
        self.vocab_dict.update({
            "ἀγαθός": ("gut, anständig", "ἀγαθός, ή, όν", 
                      "3 Steigerungsreihen: 1) ἀμείνων/ἄμεινον [vortrefflicher, besser], ἄριστος; 2) κρείττων/κρεῖττον [stärker, besser], κράτιστος; 3) βελτίων/βέλτιον [ethisch besser], βέλτιστος. τὸ ἀγαθόν - das Gute; τὰ ἀγαθά - die guten Dinge; Tugenden; Güter, Besitz"),
    ...
    def finde_bedeutung(self, griechisch: str) -> Tuple[Optional[List[str]], bool, str]:
        ...
        if suchbegriff in self.vocab_dict:
            ...
            # Alle Bedeutungen einzeln auflisten
